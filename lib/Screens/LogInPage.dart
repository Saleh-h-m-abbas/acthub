...
class _LogInPageState extends State<LogInPage> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          Stack(
            children: [
              Image.asset('Images/HeaderLogoB.png',
          ...
          Column(
            children: [
              ...
              textFiled('Password',TextInputType.visiblePassword, true), //text filed for password
              Padding(
                  padding: EdgeInsets.only(top: 90,bottom: 20),
                 child: buttons('Login',Palette.green,(){}),
              ),//contain the button of log in
              buttons("Don't have an account?",Palette.orange,(){}),//button for dont have an account
  ...
  return Container(
    ...
    child: TextField(
      obscureText: obscure,
      obscuringCharacter: '*',
      keyboardType: keyboardType,//to choose keboardtype
