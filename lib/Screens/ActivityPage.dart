                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(top:110,right: 15),
                                  child: Row(
                                ...
                                Text('From Ain Fawar to Wadi Qelt\n',
                                  style: TextStyle(
                                    fontSize: 13.5,
                                    fontWeight: FontWeight.bold,
                                    color: Palette.actHubGreen,
                                  ),),
                                Text('Unlock your full potential with our hiking tour.\nExplore the best hiking sights with us!!',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Palette.actHubGreen,
                                  ),),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Icon(Icons.phone_enabled_rounded,color: Colors.grey,),
                                          Padding(padding: EdgeInsets.only(left: 8),
                                            child: Text('+02 2815291',
                                      ...
                                      Row(
                                        children: [
                                          SvgPicture.asset(
                                            ...
                                            height: 20,
                                            color:
                                            Color(0xFF566357).withOpacity(0.35),
                                          ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Padding(padding: EdgeInsets.only(left: 10),
                                      child: Text('tayyahyazan@gmail.com',
                                        style: TextStyle(color: Colors.grey,
                                          fontSize: 15,
                                          fontWeight: FontWeight.bold,
                                        ),) ,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text('5',style: TextStyle(fontSize: 20,color: Palette.actHubYellow),),
                                )
                              ],
                            ),
                            Row(
