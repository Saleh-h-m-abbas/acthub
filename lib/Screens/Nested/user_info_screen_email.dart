...
class UserInfoScreenEmail extends StatefulWidget {
  const UserInfoScreenEmail({Key key,  User user})
      : _user = user,
        super(key: key);
  ...
  @override
  _UserInfoScreenEmailState createState() => _UserInfoScreenEmailState();
}

class _UserInfoScreenEmailState extends State<UserInfoScreenEmail> {
