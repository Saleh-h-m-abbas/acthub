...
class _HomePageState extends State<HomePage> {
  ...
  Widget CetegoryWidget(BuildContext context, String Category, String Url, {void Function() onTap}) {
  ...
  Widget Adv_example_card(BuildContext context) {
    return Card(
      ...
      elevation: 5,
      child: Container(
        width: isLandScape?MediaQuery.of(context).size.width * 0.45:MediaQuery.of(context).size.width * 0.9,
        height:isLandScape?MediaQuery.of(context).size.height * 0.25: MediaQuery.of(context).size.height * 0.22,
              ...
              Container(
                ...
                child: AppBar(
                  ...
                  actions: [
                    isGuest?
                    Padding(
                      padding:  EdgeInsets.only(right:  MediaQuery.of(context).size.width*0.01, top: MediaQuery.of(context).size.height*0.01),
                      child: CircleAvatar(
                          ...
                          Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        width: MediaQuery.of(context).size.width*0.003, color: Palette.white)),
                              ))
                        ],
                      ),
                    )
            ...
            child: AppBar(
              ...
              actions: [
                ...
                Padding(
                  ...
                  MediaQuery.of(context).size.width*0.1, top: MediaQuery.of(context).size.height*0.01),
                  child: CircleAvatar(
                    radius: MediaQuery.of(context).size.width*0.0603,
                    backgroundImage:AssetImage("Images/gusetProfilepic.png"),
                    backgroundColor: Palette.white,
