...
class _ManagementPageState extends State<ManagementPage> {
  ...
  Widget userPage() {
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.all(allWidth(context) * 0.020),
        child: Center(
          child: Container(
  ...
  Widget serviceProviderPage() {
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.only(
            left: allWidth(context) * 0.018, top: allHeight(context) * 0.05),
        child: SingleChildScrollView(
          child: Center(
            child: Column(
              children: [
                ...
                activitiesContainer('Rejected',
                    'https://www.cbmcint.com/wp-content/uploads/2016/01/February-22-MM-option-one.jpg'),
                SizedBox(
                  height: allHeight(context) * 0.01,
                ),
                activitiesContainer('Pending',
                    'https://simplifyingfamily.com/wp-content/uploads/2013/07/Summer-activities-for-families.jpg.webp'),
              ],
            ),
          ),
        ),
